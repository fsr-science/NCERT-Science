...
```mermaid
mindmap
  root((BIOLOGICAL CLASSIFICATION))
    History of Classification Systems
      Two Kingdom System
        Aristotle / Linnaeus
        Plantae and Animalia only
        Did not distinguish eukaryotes-prokaryotes
      Five Kingdom System
        R.H. Whittaker 1969
    ...
    Kingdom Monera
      ...
      Reproduction
        Binary fission
        Conjugation with genetic recombination
    Kingdom Protista
      Chrysophytes
    ...
    Symbiotic Associations
      Lichens - algae plus fungi
      Mycorrhiza - fungi plus roots
    Kingdom Plantae
      Eukaryotic chlorophyllous
      Cell wall present
    Kingdom Animalia
    ...
    Viruses Viroids Prions
      ...
      Nucleoprotein obligate parasites
      Viroids - Diener - free RNA no protein coat
      Lichens revisited under symbiosis
```
...
```mermaid
flowchart TD
    Living[All Living Organisms] --> M[Kingdom Monera<br/>Prokaryotic]
    Living --> P[Kingdom Protista<br/>Unicellular Eukaryotic]
    Living --> F[Kingdom Fungi<br/>Heterotrophic, Chitinous Wall]
    Living --> Pl[Kingdom Plantae<br/>Photosynthetic, Cellulose Wall]
    Living --> A[Kingdom Animalia<br/>Heterotrophic, No Cell Wall]

    style Living fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style M fill:#fef08a,stroke:#eab308,stroke-width:2px
    style P fill:#fef08a,stroke:#eab308,stroke-width:2px
    style F fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Pl fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
...
```mermaid
flowchart LR
    B[Bacteria] --> Coc["Coccus<br/>(spherical)"]
    B --> Bac["Bacillus<br/>(rod-shaped)"]
    B --> Vib["Vibrio<br/>(comma-shaped)"]
    B --> Spi["Spirillum<br/>(spiral-shaped)"]

    style B fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Coc fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Bac fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Vib fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Spi fill:#fef08a,stroke:#eab308,stroke-width:2px
```
...
```mermaid
flowchart TD
    Bact[Bacterial Cell] --> BF["Binary Fission<br/>(primary reproductive mode)"]
    Bact -->|Under unfavourable conditions| Spore["Spore Formation"]
    Bact -->|"DNA transfer between two cells"| Conj["Conjugation<br/>Primitive sexual mode of<br/>genetic material transfer"]

    style Bact fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style BF fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Spore fill:#e2e8f0,stroke:#64748b,stroke-width:2px
    style Conj fill:#86efac,stroke:#16a34a,stroke-width:2px
```
...
```mermaid
flowchart TD
    Prot[Kingdom Protista] --> Chry["Chrysophytes<br/>Diatoms + Golden Algae"]
    Prot --> Dino["Dinoflagellates<br/>Mostly Marine, Photosynthetic"]
    Prot --> Eug["Euglenoids<br/>Fresh water, Pellicle-bound"]
    Prot --> Slime["Slime Moulds<br/>Saprophytic, Amoeboid"]
    Prot --> Proto["Protozoans<br/>Heterotrophic, Predatory/Parasitic"]

    style Prot fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Chry fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Dino fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Eug fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Slime fill:#e2e8f0,stroke:#64748b,stroke-width:2px
    style Proto fill:#86efac,stroke:#16a34a,stroke-width:2px
```
...
```mermaid
flowchart TD
    Fungus[Fungal Reproduction] --> Veg["Vegetative<br/>Fragmentation, Fission, Budding"]
    Fungus --> Asex["Asexual<br/>via Spores: Conidia, Sporangiospores, Zoospores"]
    Fungus --> Sex["Sexual<br/>via Spores: Oospores, Ascospores, Basidiospores"]

    Sex --> Plasmo["Step 1: Plasmogamy<br/>Fusion of protoplasms between two motile/non-motile gametes"]
    Plasmo --> Karyo["Step 2: Karyogamy<br/>Fusion of two nuclei"]
    Karyo --> Meiosis["Step 3: Meiosis in Zygote<br/>Produces Haploid Spores"]

    style Fungus fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    style Veg fill:#e2e8f0,stroke:#64748b,stroke-width:2px
    style Asex fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Sex fill:#fef08a,stroke:#eab308,stroke-width:2px
    style Plasmo fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style Karyo fill:#bbf7d0,stroke:#22c55e,stroke-width:2px
    style Meiosis fill:#86efac,stroke:#16a34a,stroke-width:2px
```
