...
## Key Historical Persons (Chapter 5)

| Person | Contribution | Period |
|---|---|---|
| **James Prescott Joule** (1818–1889) | Established equivalence of heat and mechanical work; defined the joule | ~1840s |
| **James Watt** (1736–1819) | Improved the steam engine; unit of power named after him; introduced horse-power | ~1760s |
| **Robert Hooke** (1635–1703) | Discovered the law of elasticity (Hooke's Law): F = −kx | ~1660 |
| **Gottfried Wilhelm Leibniz** (1646–1716) | Introduced the concept of *vis viva* (living force) = mv², precursor to kinetic energy | ~1680s |
| **Thomas Young** (1773–1829) | First used the word "energy" in its modern scientific sense | ~1807 |

---

## Important Numerical Values to Remember
...
| Speed of bullet (typical) | ~200–500 m s⁻¹; KE ~ 10³ J |
| Speed of car (100 km/h ≈ 28 m s⁻¹) | KE of 1000 kg car ≈ 4 × 10⁵ J |

---

## Contrast Table — Elastic vs Inelastic vs Perfectly Inelastic

| Property | Elastic | Inelastic | Perfectly Inelastic |
|---|---|---|---|
| Linear momentum | Conserved | Conserved | Conserved |
| Kinetic energy | Conserved | Partially lost | Maximum loss |
...
| Example | Billiard balls (approx.) | Car crash | Bullet embedding in block |
